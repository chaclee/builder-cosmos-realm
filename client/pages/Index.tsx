...
export default function Index() {
  ...
  const updateColor = useCallback((newRgb: { r: number; g: number; b: number }) => {
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {currentColor.rgb.r}, {currentColor.rgb.g}, {currentColor.rgb.b} <Copy className="w-3 h-3 ml-1" />
                    </Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {currentColor.hsl.h}°, {currentColor.hsl.s}%, {currentColor.hsl.l}% <Copy className="w-3 h-3 ml-1" />
                    </Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge 
                      variant="secondary"
                      className="cursor-pointer hover:bg-slate-200"
                      onClick={() => copyToClipboard(`hsv(${currentColor.hsv.h}, ${currentColor.hsv.s}%, ${currentColor.hsv.v}%)`, "HSV")}
                    >
                      {currentColor.hsv.h}°, {currentColor.hsv.s}%, {currentColor.hsv.v}% <Copy className="w-3 h-3 ml-1" />
                    </Badge>
                  </div>
                </div>
              </CardContent>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        onValueChange={([r]) => updateColor({ ...currentColor.rgb, r })}
                        max={255}
                        step={1}
                        className="w-full"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        onValueChange={([g]) => updateColor({ ...currentColor.rgb, g })}
                        max={255}
                        step={1}
                        className="w-full"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Slider
                        ...
                        onValueChange={([b]) => updateColor({ ...currentColor.rgb, b })}
                        max={255}
                        step={1}
                        className="w-full"
                      />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateColor({ ...currentColor.rgb, r: Math.max(0, Math.min(255, r)) });
                          }}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateColor({ ...currentColor.rgb, g: Math.max(0, Math.min(255, g)) });
                          }}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateColor({ ...currentColor.rgb, b: Math.max(0, Math.min(255, b)) });
                          }}
                        />
                      </div>
                    </div>
